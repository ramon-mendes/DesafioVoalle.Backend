        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DtExpires = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAppTokens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserAppTokens_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.InsertData(
                table: "UserManagers",
                columns: new[] { "Id", "Email", "Idiom", "Name", "PWD" },
                values: new object[] { 1, "ramon@misoftware.com.br", 0, "Ramon", "SEnha123" });
